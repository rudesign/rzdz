...
function CheckAuthentication()
{
    ...
    return !@$_SESSION['admin_id'] ? false : true;
}
...
foreach($access_denied_dirs as $dir){
    $config['AccessControl'][] = Array(
        'role' => '*', 'resourceType' => 'Images',
        'folder' => $dir,
        'folderView' => false, 'folderCreate' => false, 'folderRename' => false, 'folderDelete' => false,
        'fileView' => false, 'fileUpload' => false, 'fileRename' => false, 'fileDelete' => false);
}
